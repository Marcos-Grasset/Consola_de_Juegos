...
# musica y sonidos
pygame.mixer.music.load("Snake/musicaFondo.mp3")
pygame.mixer.music.play(-1)  # Reproducir en bucle

sonido_comer = pygame.mixer.Sound("Snake/pop.mp3")
sonido_choque = pygame.mixer.Sound("Snake/thud.mp3")
...
def mostrar_pantalla_inicio():
    ...
    imagen_titulo = pygame.image.load("Snake/snake.png")
