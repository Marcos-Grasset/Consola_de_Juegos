...
background = pygame.image.load("Ping Pong/cancha.png")
background = pygame.transform.scale(background, (WIDTH, HEIGHT))

# Cargar el sonido de rebote
bounce_sound = pygame.mixer.Sound("Ping Pong/rebote.ogg")

# Cargar la música de fondo y configurarla para que suene en loop
pygame.mixer.music.load("Ping Pong/pongmusica.ogg")  # Cargar la música
...
def show_start_screen():
    ...
    start_image = pygame.image.load("Ping Pong/start.png")  # Asegúrate de tener la imagen en el directorio correcto
