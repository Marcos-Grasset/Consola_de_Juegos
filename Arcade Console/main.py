            ...
            for event in pygame.event.get():
                ...
                if event.type == pygame.KEYDOWN:
                    ...
                    if event.key == pygame.K_RETURN:
                        ...
                        if selected_game == 0:
                            os.system("python \"C:\\xampp\\htdocs\\Brick Breaker\\Brick Breaker\\main.py\"")  # Ejecuta el juego Brick Breaker
                        elif selected_game == 1:
                            # Aquí agregarías el código para ejecutar el juego Snake
                            pass
                        elif selected_game == 2:
                            # Aquí agregarías el código para ejecutar el juego Bubble Shooter
                            pass
                        elif selected_game == 3:
                            # Aquí agregarías el código para ejecutar el juego Ping Pong
                            pass
