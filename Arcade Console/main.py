            ...
            for event in pygame.event.get():
                ...
                if event.type == pygame.KEYDOWN:
                    ...
                    if event.key == pygame.K_RETURN:
                        ...
                        if selected_game == 0:
                            os.system("python \"C:\\Users\\Usuario\\Documents\\GitHub\\Consola_de_Juegos\\\Brick Breaker\\main.py\"")
                        elif selected_game == 1:
                            os.system("python \"C:\\Users\\Usuario\\Documents\\GitHub\\Consola_de_Juegos\\\Snake\\snake.py\"")
                        elif selected_game == 2:
                            os.system("python \"C:\\Users\\Usuario\\Documents\\GitHub\\Consola_de_Juegos\\\Bubbleshooter\\bubbleshooter.py\"")
                        elif selected_game == 3:
                            os.system("python \"C:\\Users\\Usuario\\Documents\\GitHub\\Consola_de_Juegos\\\Ping Pong\\main.py\"")
